...
<p> <a href="menu.html" class="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    //Captura datos del form anterior
    $vID = $_POST["id"];
       ...
       Consulta </a></p>");
        ...
        <form action="Modi.php" method="post" name="FormModi">
            ...
            <table width="356">
                <tr>
                    <td width="103"> ID: </td>
                    <td width="243"> <input type="text" name="id" value="<?php echo($fila['id']);?>" readonly></td>
                </tr>
                <tr>
                    <td width="103"> Ciudad: </td>
                    <td width="243"> <input type="text" name="city" value="<?php echo($fila['ciudad']);?>"></td>
                </tr>
                <tr>
                    <td width="103"> Pais: </td>
                    <td width="243"> <input type="text" name="country" value="<?php echo($fila['pais']);?>"></td>
                </tr>
                <tr>
                    <td width="103"> Habitantes: </td>
                    <td width="243"> <input type="text" name="hab" value="<?php echo($fila['habitantes']);?>"></td>
                </tr>
                <tr>
                    <td width="103"> Superficie (km2): </td>
                    <td width="243"> <input type="text" name="sup" value="<?php echo($fila['superficie']);?>"></td>
                </tr>
                <tr>
                    <td width="103"> Tiene Metros: </td>
                    <td width="243"> <input type="text" name="tieneMetros" value="<?php echo($fila['tieneMetros']);?>"></td>
                </tr>
